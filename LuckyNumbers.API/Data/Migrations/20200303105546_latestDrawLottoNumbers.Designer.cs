...
namespace LuckyNumbers.API.Migrations
{
    ...
    [Migration("20200303105546_latestDrawLottoNumbers")]
    partial class latestDrawLottoNumbers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LuckyNumbers.API.Entities.LatestDrawLottoNumbers", b =>
                {
                    b.Property<int>("latestLottoGameId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("latestLottoGameId");

                    b.HasIndex("userId")
                        .IsUnique();

                    b.ToTable("latestDrawLottoNumbers");
                });
            ...
            modelBuilder.Entity("LuckyNumbers.API.Entities.LatestDrawLottoNumbers", b =>
                {
                    b.HasOne("LuckyNumbers.API.Entities.User", "user")
                        .WithOne("latestDrawLottoNumbers")
                        .HasForeignKey("LuckyNumbers.API.Entities.LatestDrawLottoNumbers", "userId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
